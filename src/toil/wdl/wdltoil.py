...
from toil.lib.io import mkdtemp, file_digest, is_any_url, is_file_url, TOIL_URI_SCHEME, is_standard_url, is_toil_url, is_remote_url
...
class WDLWorkflowNodeJob(WDLBindingsJob):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.then_keep_only(self._inbound_references)
    ...
    def run(self, file_store: AbstractFileStore) -> Promised[WDLBindings]:
        ...
        logger.debug("Got inbound references: %s", self._inbound_references)
        ...
        for node_ids in creation_jobs:
            ...
            for node_id in node_ids:
                for variable_name in referenced_variables_from[node_id]:
                    # Keep any variables that are referenced elsewhere in the
                    # section.

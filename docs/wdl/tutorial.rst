...
Then run it with Toil. If you are on a Slurm cluster, and you are currently in a shared directory available on all your nodes, you can run::
    ...
    toil-wdl-runner --jobStore ./fizzbuzz_store --batchSystem slurm --defaultWalltime 10m --caching false --batchLogsDir ./logs fizzbuzz.wdl fizzbuzz.json -o fizzbuzz_out -m fizzbuzz_out.json
